...
public class ArrayEx4 {
	...
	public static void main(String[] args) {
		...
		System.out.println(row_count);// 행갯수
		System.out.println(col_count);// 열갯수
		System.out.println(sum_conut);// 전체 요소 갯수
...
//			System.out.println(i+"행입니다");			
		...
		System.out.println("다차원 배열요소의 합계: " + sumNum);
		System.out.println("다차원 배열요소의 평균: " + avg);
