...
public class VarEx1 {
	...
	public static void main(String[] args) {
		...
		long l=10;//long형 변수 l를 선언하고 long형 정수 10으로 초기화 했다. 8byte
		
		//실수형 자료형(타입) -> 1.1 기본 double(8byte)
		// (float)1.1 -> 강제 형변환
		float f=1.1f;//float형 변수 f를 선언하고 float형 실수1.1으로 초기화 했다.4byte
		double d=1.1;//double형 변수 d를 선언하고 double형 실수1.1으로 초기화 했다.8byte
		
		//문자형 자료형(char) -> '', 한글자
		char ch='a';//char형 변수 ch를 선언하고 char형 문자 'a'으로 초기화 했다. 2byte
		boolean bool=false;//boolean형 변수 bool를 선언하고 boolean형 false로 초기화 했다. 1byte
